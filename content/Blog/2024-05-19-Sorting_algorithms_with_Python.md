...
![PNGs of the different sorting algorithms](Assets/final.gif)
...
plt.show()
```
![Start configuration](Assets/Start.png)
...
![Radix sort](Assets/radix_sort.gif)
...
![Sleepsort](Assets/sleep_sort.gif)
